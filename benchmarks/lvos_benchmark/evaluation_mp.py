...
import numpy as np
from lvos_benchmark.lvos_seperate import LVOS
from lvos_benchmark.metrics import db_eval_boundary, db_eval_iou
from lvos_benchmark import utils
from lvos_benchmark.results import Results
...
class LVOSEvaluation(object):
    def __init__(self, lvos_root, task, gt_set, mp_procs=2, codalab=False):
        ...
        if codalab:
            ...
            self.unseen_videos=os.path.join('benchmarks', 'lvos_benchmark', 'unseen_videos.txt')
